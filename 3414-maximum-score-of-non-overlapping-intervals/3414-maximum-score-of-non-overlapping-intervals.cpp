class Solution {
public:
    struct Node { // Just to retrun pair of <int,vector> can be accessed by eg.
                  // this.src
        long long scr = -1;
        vector<int> idx;
    };
    ...
    int findNxt(vector<vector<int>>& nums,
